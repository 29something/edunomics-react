...
export class VerifiedRF7 extends Component {
    constructor() {
        super();
        this.state = {
          userdata: [],
      ...
      async handleClick() {
        ...
        try {
          const response = await axios.get(
            `${API_URL}rf_form/approved-rf/rf_07`,
            (axios.defaults.headers.common["x-access-token"] = tokenvalue)
          );
          console.log(response.data);
          if (response.status === 200) {
                              ...
                              <div className="">
                                <div className="">
                                  ...
                                  <div className="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                    ...
                                    <div className="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                      {localStorage.getItem('user_type') === 'plant technical officer' && <NavLink to="RF7">
                                        {" "}
                                        <button
                                          className="btn btn-info"
                                          style={{ float: "right" }}
                                              ...
                                              .map(function(item, id) {
                                                return (
                                                  ...
                                                  >
                                                    ...
                                                    <td>
                                                    <Link to={process.env.PUBLIC_URL + `/ViewRf7/${item.id}`}><button  className="btn btn-success custom-edit-btn btn-sm" ><i class="fa fa-trash-o" aria-hidden="true"></i>&nbsp;&nbsp;View</button></Link>
                                                      {localStorage.getItem('user_type') === 'quality incharge' && <Link to={process.env.PUBLIC_URL + `/VerifyRF7/${item.id}`}><button className="btn btn-warning custom-edit-btn btn-sm"><i class="fa fa-pencil" aria-hidden="true"></i>&nbsp; &nbsp; Verify</button></Link>}
