...
export class VerifiedRF21 extends Component {
    constructor() {
        super();
        this.state = {
          userdata: [],
      ...
      async handleClick() {
        ...
        try {
          const response = await axios.get(
            `${API_URL}rf_form/approved-rf/rf_21`,
            (axios.defaults.headers.common["x-access-token"] = tokenvalue)
          );
          console.log(response.data);
          if (response.status === 200) {
                              ...
                              <div className="">
                                <div className="">
                                  ...
                                  <div className="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                    ...
                                    <div className="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                      {localStorage.getItem('user_type') === 'plant technical officer' && <NavLink to="RF21">
                                        {" "}
                                        <button
                                          className="btn btn-info"
                                          style={{ float: "right" }}
