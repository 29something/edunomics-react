...
export class VerifyRF27 extends Component {
    constructor(props) {
        super(props);
        this.state = {
            verify_comment : "",
        ...
        <div className="skin-blue fixed-layout">
             <div className="page-wrapper">
                   ...
                   <div className="below-custom-form">
                     ...
                     <div class="form-group col-md-6">
                           <div class="form-group row">
                             ...
                             <div class="col-sm-10">
                                 <inptu type="text" className="form-control" value={this.state.plant} name="plant" disabled />
                             </div>
                           </div>
                         </div>
                     </div>
                     ...
                     <div class="form-group row">
                         ...
                         <div class="form-group col-md-6">
                           <div class="form-group row">
                             ...
                             <div class="col-sm-10"><inptu type="text" className="form-control" value={this.state.date} name="date" disabled /></div>
                           </div>
                         </div>
                       </div>
                       <div className="form-row">
               ...
               <div class="form-group row">
                 ...
                 <inptu type="text" className="form-control" value={this.state.admixture_type} name="admixture_type" disabled />
                 </div>
               </div>
             </div>
