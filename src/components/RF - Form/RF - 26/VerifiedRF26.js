...
export class VerifiedRF26 extends Component {
    constructor() {
        super();
        this.state = {
          newaddata : [],
      ...
      async handleClick() {
        ...
        try {
          const response = await axios.get(
            `${API_URL}rf_form/approved-rf/rf_26`,
            (axios.defaults.headers.common["x-access-token"] = tokenvalue)
          );
          const newresponse = await axios.get(
            `${API_URL}rf_form/approved-rf/rf_76`,
            (axios.defaults.headers.common["x-access-token"] = tokenvalue)
          );
