...
export class TableRf8 extends Component {
    constructor() {
        super();
        this.state = {
          userdata: [],
                              ...
                              <div className="">
                                <div className="">
                                  ...
                                  <div className="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                    ...
                                    <div className="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                      {localStorage.getItem('user_type') === 'plant technical officer' && <NavLink to="RF8">
                                        {" "}
                                        <button
                                          className="btn btn-info"
                                          style={{ float: "right" }}
                                              ...
                                              .map(function(item, id) {
                                                return (
                                                  ...
                                                  >
                                                    ...
                                                    <td>
                                                    <Link to={process.env.PUBLIC_URL + `/ViewRF8/${item.id}`}><button  className="btn btn-success custom-edit-btn btn-sm" ><i class="fa fa-trash-o" aria-hidden="true"></i>&nbsp;&nbsp;View</button></Link>
                                                      {localStorage.getItem('user_type') === 'quality incharge' && <Link to={process.env.PUBLIC_URL + `/VerifyRF8/${item.id}`}><button className="btn btn-warning custom-edit-btn btn-sm"><i class="fa fa-pencil" aria-hidden="true"></i>&nbsp; &nbsp; Verify</button></Link>}
