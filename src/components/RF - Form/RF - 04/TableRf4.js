...
export class TableRf4 extends Component {
    constructor() {
        super();
        this.state = {
          userdata: [],
      ...
      async handleClick() {
        ...
        try {
          const response = await axios.get(
            `${API_URL}assets/rf_4_view`,
            (axios.defaults.headers.common["x-access-token"] = tokenvalue)
          );
          console.log(response.data.tempdata);
          if (response.data.tempdata.length) {
            this.setState({ userdata: response.data.tempdata });
          }
        } catch (error) {
          console.log(error);
        }
                              ...
                              <div className="">
                                <div className="">
                                  ...
                                  {/* <div className="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                    ...
                                    <div className="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                      {localStorage.getItem('user_type') === 'plant technical officer' && <NavLink to="Ambient">
                                        {" "}
                                        <button
                                          className="btn btn-info"
                                          style={{ float: "right" }}
                                      ...
                                      <table className="table table-hover table-bordered ">
                                        <thead className="bg-info custom-thead-color">
                                          <tr>
                                            ...
                                            <th scope="col" colSpan="2">Temprature Day</th>
                                            <th scope="col" colSpan="2">Temprature Night</th>
                                          </tr>
                                        </thead>
                                        <tbody>
                                        <tr>
                                              ...
                                              .map(function(item, id) {
                                                return (
                                                  ...
                                                  <Moment format="LL">
                                                    ...
                                                    <td>{item.temp_amb_d}</td>
                                                    <td scope="row">{item.temp_tank_d}</td>
                                                    <td scope="row">{item.temp_amp_n}</td>
                                                    <td scope="row">{item.temp_tank_n}</td>
                                                    {/* <td> */}
