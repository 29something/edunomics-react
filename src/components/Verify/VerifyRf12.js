...
export class VerifyRf12 extends Component {
    constructor(props) {
        super(props);
        this.state = {
          verify_comment: "",
                  ...
                  <div className="below-custom-form">
                    <div className="row">
                      <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        RF - 12 : Determination of Specific Gravity and Water Absorption of Coarse aggregate [Method II] IS : 2386 (Part 3) – 1963 
                        <hr />
                      </div>
                      {/* <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <h3>View RF 13</h3>
